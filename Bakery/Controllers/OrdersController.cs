...
namespace Bakery.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var bakeryDBContext = _context.Orders.Include(o => o.BakeryProduct);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,BakeryProductId,CustomerName,ProductName,ProductType,Quantity,Price,OrderDate,DeliveryDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,BakeryProductId,CustomerName,ProductName,ProductType,Quantity,Price,OrderDate,DeliveryDate")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
